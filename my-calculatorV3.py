...
def request_expression(history, reset_history):
    ...
    while True:
        ...
        elif expression.lower() == "clearhistory":
            # Clear the history
            history = []
        ...
        elif expression.lower() == "resethistory":
...
if __name__ == "__main__":
    ...
    request_expression(history, reset_history)
